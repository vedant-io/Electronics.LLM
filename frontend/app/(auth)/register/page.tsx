      ...
      >
        ...
        <div className="flex flex-col gap-3 mb-6">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full h-11 rounded-xl border border-white/[0.12] bg-white/[0.03] hover:bg-white/[0.07] transition-colors text-sm font-medium"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {roles.map((r) => {
                ...
                return (
                  <button
                    ...
                    `}
                  >
                    <r.icon className={`size-5 ${isSelected ? "text-primary" : "text-muted-foreground"}`} />
                    <div>
                      <div className={`text-sm font-medium ${isSelected ? "text-foreground" : "text-muted-foreground"}`}>{r.label}</div>
          ...
          <Button type="submit" disabled={isLoading} className="w-full h-11 text-sm font-medium mt-1" size="lg">
            {isLoading ? <Loader2 className="size-4 animate-spin" /> : (<>Create Account <ArrowRight className="size-4" /></>)}
          </Button>
        </form>
      </motion.div>
