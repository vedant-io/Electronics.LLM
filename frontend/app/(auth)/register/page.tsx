    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 mb-6">
          <a href="/api/auth/google" target="_top" className="flex items-center justify-center gap-3 w-full h-11 rounded-xl border border-white/[0.12] bg-white/[0.03] hover:bg-white/[0.07] transition-colors text-sm font-medium">
          ...
          <a href="/api/auth/github" target="_top" className="flex items-center justify-center gap-3 w-full h-11 rounded-xl border border-white/[0.12] bg-white/[0.03] hover:bg-white/[0.07] transition-colors text-sm font-medium">
